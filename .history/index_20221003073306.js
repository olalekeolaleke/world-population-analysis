...
var myMap = L.map("map", {
  ...
  // Add a tile layer.
  ar street = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}", {
  ...
  var countries = [
    ...
    // Looping through the countries array, create one marker for each city, bind a popup containing its name and population, and add it to the map.
  for (var i = 0; i < countries.length; i++) {
    
   // Conditionals for country 2022 population
   var color = "";
