    ...
    // function BuildCharts(selected) {
        ...
        // d3.json("/static/js/30_most_populous.json").then((data) => {
        ...
        // var population = results[0].pop2022
    ...
    function init() {
        ...
        d3.json("/static/js/world_population.json").then((data) => {
    ...
    function updatedCharts(sample) {
        d3.json("/static/js/world_population.json").then((data) => {
            ...
            var layout = {
                    height: 500,
                    width: 1000,
                    title: "Top 20 World Most Populous Countries"
                };
    var trace1 = {
