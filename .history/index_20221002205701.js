...
var myMap = L.map("map", {
  ...
  for (var i = 0; i < countries.length; i++) {
    ...
    var color = "";
    if (countries[i].pop2022 > 100000) {
      color = "yellow";
    }
    else if (countries[i].pop2022 > 75000) {
      color = "blue";
    }
    else if (countries[i].pop2022 > 50000) {
      color = "green";
    }
    else {
      color = "violet";
    ...
    }).bindPopup(`<h1>${countries[i].id}</h1> <hr> <h3>GDP Per Capita (USD): ${countries[i].pop2022}</h3>`).addTo(myMap);
  }
