...
//     console.log(countries);
  ...
  for (var i = 0; i < countries.length; i++) {
   ...
   if (countries[i].pop2022 > 1000000) {
   ...
   else if (countries[i].gdp_pc > 100000) {
     color = "blue";
   }
   else if (countries[i].gdp_pc > 10000) {
     color = "green";
   }
   else {
     color = "violet";
    ...
    L.marker(countries[i].location)
      .bindPopup(`<h1>${countries[i].id}</h1> <hr> <h3>Population ${countries[i].pop2022.toLocaleString()}</h3>`)
      .addTo(myMap);
  }
//   });
